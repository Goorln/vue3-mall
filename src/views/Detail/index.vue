    ...
    <div class="container">
      <div class="bread-container">
        <el-breadcrumb separator=">">
          ...
          <!-- 
            错误原因：goodsData刚开始是{}空对象，{}.categories -> undefined -> undefined[1]
            1. 可选链的语法：?.
            2. v-if手动控制渲染时机，保证只有数据存在才渲染  给container加 v-if="goodsData.details"
           -->
